...
class Restaurant_Screen extends StatefulWidget {
  const Restaurant_Screen({super.key});

  @override
  State<Restaurant_Screen> createState() => _Restaurant_ScreenState();
}
...
class _Restaurant_ScreenState extends State<Restaurant_Screen> {
  ...
  @override
  void initState() {
    current_place = restaurant_items[0];
    super.initState();
  }
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              return Swiper(
                ...
                itemCount: restaurant_items.length,
                ...
                onIndexChanged: (value) {
                  setState(() {
                    current_place = restaurant_items[seletedindex];
                  });
                },
                onTap: (index) {
                  context.push(Routes.checkoutscreen.path,
                      extra: restaurant_items[index]);
                },
                itemBuilder: (context, index) {
                  seletedindex = index;
                  var data = restaurant_items[index];
                  return ImageCard(
                    model: data,
                  );
                },
